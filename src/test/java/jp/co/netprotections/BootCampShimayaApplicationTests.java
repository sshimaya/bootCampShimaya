...
@SpringBootTest
public class BootCampShimayaApplicationTests {
	...
	public void hasInvalidArgument () {
		...
		String resultName = "a";
		boolean enlistedPripriety = true;
		...
		if(req.getEventPlanning() < 0 || req.getEventPlanning() > 5) {
			boolean enlistedPropriety = false;
		}
        ...
        assertEquals(expectedEnlistedProproety, enlistedPripriety);
